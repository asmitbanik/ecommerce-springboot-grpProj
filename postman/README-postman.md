...
- Expected: 200 OK, body: {"paymentId":"mock_xxx","paymentUrl":"https://razorpay.example/pay/mock_xxx"}
...
- Currently security was temporarily relaxed to allow easier testing;
